---
name: One-Army Architecture
description: Master template for unified system architecture.
grade: B
tags: [blueprint, architecture, standard]
pros: ["Unified monorepo", "Scalable services"]
